...
| Git / release discipline | Feature branch pushed | `main` is seeded at `f45c0a3`; `feature/livekit-voice-proof-capture` is pushed at `7c4955b`; remote CI run `26360881281` passed | **55** | Manual PR/merge, branch protection, auto-merge setup, and tagged release still pending |
