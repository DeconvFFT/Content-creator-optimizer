...
- PR/CI handoff: feature branch remote CI was green for the current pushed head at last live check. GitHub connector PR creation still returns `403 Resource not accessible by integration`, and REST lookup shows no open PR. Use `uv run all-about-llms-admin provider-proof-pr-handoff --run-id 190ae2f9-a74b-4a23-b39c-aaf2d636bd8e --operator-input-path social_media_optimiser/output/provider-proof/190ae2f9-a74b-4a23-b39c-aaf2d636bd8e/operator-inputs.template.env` for a no-secret manual PR body.
