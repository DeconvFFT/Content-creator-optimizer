...
| **Refreshed 2026-05-28: current PR and merge-gate handoff** | [[../cloud]] / [[../social_media_optimiser/wiki/ops/active-codex-context]] / [[06-live-voice/openrouter-livekit-current-unblock-guide]] | Current pushed branch is `fix_20260528-live-postgres-gate` at `3dc61a30a67598e87e4a273cc695c241f8250eea`; branch-push product CI run `26577750258` passed, Auto PR run `26577750829` failed at draft PR mutation with GitHub `403`, no open PR exists for the branch, `provider-proof-pr-create` returned `manual_required` / `github_token_unavailable`, and `Live Postgres (PR/main/manual)` is now configured to run on pull requests before merge. | Create the manual PR from the current compare URL or provide PR mutation credentials/permissions, then wait for PR CI including live Postgres |
