...
- Fresh 2026-05-24 PR dry-run evidence: branch head `58b0dc6393f8580a82f6d160b884ca44cfe78eb5` generated a draft PR request shape for `feature/livekit-voice-proof-capture` into `main` with no secret values printed. The intended committed dependency artifact is `uv.lock`; local command logs remain untracked.
